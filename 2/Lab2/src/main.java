...
public class main {
    ...
    public static void Task5(Scanner Scan, int resm)
    {
        ...
        int numberOp = Scan.nextInt();
        System.out.println("\nРезультат задания 5: ");
        switch (numberOp)
        {
            case 1: System.out.println("Результат сложения: " + (x + y)); break;
            case 2: System.out.println("Результат вычитания: " +(x - y)); break;
            case 3: System.out.println("Результат умножения: " +(x * y)); break;
            case 4: System.out.println("Результат деления: " +(x / y)); break;
